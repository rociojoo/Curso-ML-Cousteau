...
<!--   * Mismo ejercicio y modelo que en *2.* -->
...
* Calcular la **importancia** de las variables en el modelo
...
```{r, out.width = "50%", fig.align='center', echo=FALSE}
knitr::include_graphics("./img/dials.jpeg")
```
...
Esta vez, ajustaremos los modelos con parametrizaciones distintas a varias 
muestras generadas a partir de los datos de entrenamiento. 
...
A partir de estos resultados podemos hacer una búsqueda de combinacions de 
